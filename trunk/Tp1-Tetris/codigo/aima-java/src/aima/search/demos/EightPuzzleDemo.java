...
public class EightPuzzleDemo {
	...
	static EightPuzzleBoard extreme = new EightPuzzleBoard(new int[] { 0, 8, 7,
			6, 5, 4, 3, 2, 1 });
	static EightPuzzleBoard isTP = new EightPuzzleBoard(new int[] { 2, 8, 3, 1,
			6, 4, 7, 0, 5 });
	...
	public static void main(String[] args) {
		 ...
		 * eightPuzzleGreedyBestFirstManhattanDemo(); eightPuzzleAStarDemo();
		 */
	...
	private static void eightPuzzleGreedyBestFirstDemo() {
		...
		try {
			Problem problem = new Problem(isTP,
					new EightPuzzleSuccessorFunction(),
					new EightPuzzleGoalTest(),
